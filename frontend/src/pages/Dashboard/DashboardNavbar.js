    ...
    <div className="dashboardNavbar">
      ...
      <div className="dashboardNavbar_body">
          ...
          <div style={{marginTop:"5px"}} className="dashboardNavbar_balance">
            <span style={{position:"absolute",fontWeight:"300",left:"-20px",width:"10px",height:"36px",fontSize:"25px",}}>{userDetails?.currency}</span>
            {userDetails.balance!==undefined && <h1 style={{fontSize:"32px",display:"inline-block"}}>{(userDetails.balance.toFixed(2))}</h1>}
          </div>
