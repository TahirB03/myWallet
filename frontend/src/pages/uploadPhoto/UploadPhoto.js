...
const UploadPhoto = () => {
  ...
  const handleImage = async (e)=>{
      if (e.target?.files[0]?.type.includes("image")){
            ...
            try {
                const {data} = await axios.get(`https://nx1qh9klx1.execute-api.eu-south-1.amazonaws.com/dev/upload/getUploadUrl/${e.target.files[0].name.split('.')[1]}`)
    ...
    <div className="updateWrraper">
      ...
      <div className="userUpdate">
        ...
        <div className="imageUpload">
          ...
          <input type='file' id='file' onChange={handleImage} ref={inputFile} style={{display: 'none'}}/>
            <img
        ...
        {errors===true && <p style={{color:"red",fontSize:"12px"}}>Please choose an image</p>}
        </div>
